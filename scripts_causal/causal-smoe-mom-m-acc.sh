mkdir -p /hy-tmp/checkpoint-causal-acc/

args="
--data /hy-tmp/data_directory/acc/ \
...
--beta1 0.9 \
--beta2 0.999 \
--checkpoint /hy-tmp/checkpoint-causal-acc/smoe.pt \
--pretrained_weight /hy-tmp/causal-smoe/smoe.pt \
--cmp-sz 16 \
"
